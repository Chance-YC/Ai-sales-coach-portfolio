...
> Demo 内置本地规则引擎模拟生成效果。接入真实 LLM 只需替换 `generateWithLLM()` 一个函数，接口已在代码中预留并注释（详见[技术方案 §5](./docs/06-技术方案与内部设计.md#5-话术生成引擎设计)）。
...
> **SalesMate · AI 销售作战助手（个人产品项目，含可交互原型）**
> - 独立完成从用户调研（访谈 8 人 + 问卷 45 份）、需求分析（KANO / RICE）、产品路线规划到 PRD 撰写与技术方案设计的全流程
> - 设计「场景话术生成 / 异议应对 / 跟进邮件」三大核心功能，产出结构化 PRD 与可交互原型
> - 项目文档与原型：github.com/<你的用户名>/SalesMate

---

**作者**：`池勇枨` ｜ 产品经理 / 销售 ｜ 联系方式：`18976874031@163.com`
